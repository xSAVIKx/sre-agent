...
This skill should be triggered when a developer reports system errors, slow response times, service outages, or specifically requests to diagnose latency spikes or HTTP 5xx failures in their microservices stack.
